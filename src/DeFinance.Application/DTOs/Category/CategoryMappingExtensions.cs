...
public static class CategoryMappingExtensions
{
    public static CategoryResponse ToResponse(this Domain.Entities.Category category) =>
        new(category.Id, category.Name, category.Type, category.Color, category.Icon, category.ParentId, category.Parent?.Name, category.PaymentObligation, category.IsActive, category.IsImportant);
